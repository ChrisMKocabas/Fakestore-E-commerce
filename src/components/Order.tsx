...
const Order = ({
  ...
  return (
    <div className="relative border shadow-lg rounded-md">
      <div className="flex items-center space-x-10 p-5 bg-[#ffc100] text-sm rounded-t-md">
        ...
        <p className="text-[#ffc100] text-sm whitespace-nowrap sm:text-lg self-end flex-1 text-right">
          {items.length} Item(s)
        </p>

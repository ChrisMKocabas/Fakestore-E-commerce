    ...
    <div className="bg-gradient-to-tr from-red-100 to-yellow-100 h-screen">
      ...
      <main className="max-w-screen-lg mx-auto">
        <div className="flex flex-col p-10 bg-white shadow-md mt-5 rounded-md">
          <h2 className="text-center text-lg font-bold mb-5">About</h2>
          <p className="text-sm">
            Fake Store is intended to showcase a full stack E-Commerce App for
            portfolio purposes. Please do not use real card info for Stripe
            Checkout. (Instead use 4242 pattern for all card details)
          </p>
          <div>
          ...
          <button
            onClick={() =>
              router.push(
                "https://github.com/ChrisMKocabas/Fakestore-E-commerce"
              )
            }
